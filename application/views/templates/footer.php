...
<!-- Favicons -->
<!-- <link rel="icon" type="image/png" href="<?php echo base_url() ?>assets/img/favicon16.png" sizes="16x16">
	<link rel="icon" type="image/png" href="<?php echo base_url() ?>assets/img/favicon32.png" sizes="32x32">

<head>
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/diseno_mecanico.css">
</head>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row seccion proveedores">
            ...
            <div class="col-6 col-sm-4 col-md-2 proveedor">
...
<script src="<?php echo base_url(); ?>assets/js/diseno_mecanico.js"></script>